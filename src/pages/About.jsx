  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold mb-4">About StyleSpot</h1>
        <p className="text-gray-600 max-w-2xl mx-auto">
          Your destination for curated fashion and unique style inspiration. We believe in making fashion accessible, 
          sustainable, and personal for everyone.
        </p>
      </div>
